...
session-relationship contract version 1, session evidence contract version 1,
and session usage contract version 1, normalizes nullable fields, maps native errors, and supplies pagination
helpers.
