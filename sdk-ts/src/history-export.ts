...
/** A bounded snapshot of the rows the store holds now. */
 ...
 * snapshot. Explicit handles support durable cursor resume until expiry; a
 * snapshot covers the rows present when it was created. */
