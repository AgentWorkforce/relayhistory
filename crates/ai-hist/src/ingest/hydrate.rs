...
/// so their relationship coverage is recomputed under the bounded search, and
/// makes pre-parity OpenCode sessions re-read their full event evidence.
